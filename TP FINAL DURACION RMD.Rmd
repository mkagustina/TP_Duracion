...
El cáncer de mama es un tipo de cáncer primario, que se origina en la mama y puede propagarse a otros tejidos u órganos del cuerpo.
Es el tipo de cáncer más frecuente y la causa más común de muerte por cáncer en mujeres a nivel mundial.[^1]
...
datos_tabla <- data.frame(
  ...
  p_value = c("< 0.0001", "0.0095", "0.4000", "0.2200","0.7700", "0.0590", "0.4400", "0.62")
)
