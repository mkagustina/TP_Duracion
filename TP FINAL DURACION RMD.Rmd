...
ggsurvplot(fit = KM.segun.age, data = datos1, 
           ...
           )$plot + labs(caption = "Gráfico 10: Probabilidad de supervivencia estimada según edad") +
   geom_segment(data = mediana, aes(x = X50, xend = X50,  y = 1-q, yend = 0), lty = 3) +
  geom_segment(data = mediana, aes(x = 0, xend = X50,  y = 1-q, yend = 1-q), lty = 3)
...
ggsurvplot(fit = KM.segun.meno, data = datos1,
           ...
           #pval.method = T,
           #log.rank.weights = "n"
           )$plot + labs(caption = "Gráfico 11: Probabilidad de supervivencia estimada según menopausia") +
  geom_segment(data = mediana, aes(x = X50, xend = X50,  y = 1-q, yend = 0), lty = 3) +
  geom_segment(data = mediana, aes(x = 0, xend = X50,  y = 1-q, yend = 1-q), lty = 3)
```
...
ggsurvplot(fit = KM.segun.er, data = datos_graf,
           ...
           )$plot + labs(caption = "Gráfico 12: Probabilidad de supervivencia estimada según\n presencia o ausencia receptores de estrógeno") +
  geom_segment(data = mediana, aes(x = X50, xend = X50,  y = 1-q, yend = 0), lty = 3) +
  geom_segment(data = mediana, aes(x = 0, xend = X50,  y = 1-q, yend = 1-q), lty = 3)
```
