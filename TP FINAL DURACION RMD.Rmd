...
Considerendo los test de hipótesis realizados y con un nivel de significación del 5%, se presentan las curvas de supervivencia de aquellos cuyo resultado condujo a "*Rechazar* $\ H_{0}$".
...
# Función de supervivencia según si recibó o no quimioterapia
...
annotations <- data.frame(
  size = c("menor a 20mm", "entre 20 y 50mm", "mayor a 50mm",
           "menor a 20mm", "entre 20 y 50mm", "mayor a 50mm"),
...
ggsurvplot(fit = KM.segun.chemo, data = datos2,
  ...
  geom_text(data = annotations, aes(x = x, y = y, label = label, color = chemo), size = 2.5, fontface = "bold")
...
KM.segun.tamaño <- survfit(Surv(dtime, death == 0) ~ size, data = datos2)
