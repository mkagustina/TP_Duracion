...
[^1]: Fuente: [https://www.paho.org/es/temas/cancer-mama](https://www.paho.org/es/temas/cancer-mama)
...
Los datos fueron obtenidos de la base *rotterdam* del paquete *survival*. La misma cuenta con el tiempo desde la cirugía hasta la muerte o pérdida de seguimiento de la paciente, junto a otras covariables basales que se detallan a continuación:
...
De la totalidad de mujeres en estudio, contamos con el tiempo exacto hasta la muerte de 377 de ellas y 206 censuras.
...
ggsurvplot(fit = KM.segun.age, data = datos1, 
           ...
           legend.labs = c("Menos de 40", "Entre 40 y 49", "Entre 50 y 69","Más de 70"),
           ggtheme = theme_survminer() + 
             theme(plot.caption = element_text(hjust = 0.5, size = 10))
